...
| ◐ in-progress | [T-260831-01](T-260831-01-portable-data-root-decision.md) | Decide how a portable build names its data root, and record it | 📄 docs | X-09 |
| ◐ in-progress | [T-260831-02](T-260831-02-guard-every-release-artifact.md) | Guard every artifact the release build writes, not only the NSIS one | 📦 build | X-09 |
