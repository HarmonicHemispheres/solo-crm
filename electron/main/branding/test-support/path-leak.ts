...
/**
 * Walks a value the branding channels answered with and returns every string
 * in it that looks like a filesystem path.
 *
 ...
 * the check walks the whole object, every branch, every depth.
 *
 ...
 * which it was found.
 *
 * Test-support only. Nothing in `electron/main/branding/` imports it.
 */
